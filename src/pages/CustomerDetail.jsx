...
export default function CustomerDetail() {
  ...
  const handleDeleteInterval = async (productName) => {
    const interval = intervals[productName]
    if (!interval) return
    await supabase.from('customer_product_intervals').delete().eq('id', interval.id)
    setIntervals(prev => { const next = { ...prev }; delete next[productName]; return next })
  }
                              ...
                              {(() => {
                                ...
                                return (
                                  <>
                                    ...
                                    {interval && (
                                      <button
                                        onClick={() => handleDeleteInterval(productName)}
